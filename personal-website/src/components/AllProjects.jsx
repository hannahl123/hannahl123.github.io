...
// The same project data as in Projects.jsx
const projects = [
  {
    title: "Reflect.",
    description:
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="relative mb-12 flex items-center justify-center">
            <button
              ...
              className="absolute left-0 px-6 py-2 font-semibold text-primary bg-transparent border-2 border-primary rounded-full transition-all duration-300 hover:bg-primary hover:text-background flex items-center gap-2"
            >
